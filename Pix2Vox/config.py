...
__C.TEST.DIFFERENCE_THESHOLD                = - # How much of a difference you want to have between final volume and refined volume. Between[0,1]. -1 to turn off
